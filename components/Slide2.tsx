...
export const Slide2 = () => {
  ...
  useEffect(() => {
    if (slide >= 2 && document.getElementById("slide1") && !playing) {
      ...
      new Vara("#slide2", "font.json", [
        {
          text: "Sign up for NoPlayButton - where we debug code better than our life choices!", // String, text to be shown
  ...
  return (
    <div className={`w-screen h-screen flex flex-col justify-end absolute top-0 left-0`}>
  ...
  src="NoPlayButton.mp4" // Update this path to the location of your video file
>
  Your browser does not support the video tag.
      ...
      >
        <div id="slide2" className={`p-2 overflow-visible w-full`} style={{ fontFamily: 'YourFontFamily, sans-serif' }}>
        {/* The text here will use the font specified in the fontFamily style */}
      </div>
