...
const IndexPage = () => {
  ...
  return (
    <div className={`relative w-screen h-screen overflow-hidden`}>
      ...
      <div
         className={`absolute top-0 left-0 w-screen h-screen bg-gradient-to-br from-teal-100 to-cyan-200 flex flex-col items-center justify-center gap-[25%] ${slide >= 3 && `!opacity-100`} opacity-0 transition-all duration-1000 delay-700`}>
        <div />
        <div
        ...
        >
          ...
          >
        <h1 className="text-4xl font-bold text-center font-dance">You In?</h1>
          </div>
        </div>
        <span className={`absolute bottom-0 right-0 p-2 text-sm text-gray-800/40`}>
         ...
         {/* Adjusted container for buttons to position them higher */}
         <div className={`flex justify-center gap-4 mt-4 mb-5`}> {/* Increased bottom margin */}
          <a
            href="https://jaibhedia.github.io/Redirect/" 
            target="_blank" 
